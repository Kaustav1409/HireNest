...
function applyStepUi() {
  ...
  if (isRecruiter) {
    ...
    skipLink.href = "/recruiter-dashboard.html";
  ...
  skipLink.href = "/jobseeker-dashboard.html";
...
async function saveRecruiterProfile() {
  ...
  setTimeout(() => (location.href = "/recruiter-dashboard.html"), 800);
}
...
async function saveJobSeekerProfile() {
  ...
  showOnboardingMsg("Onboarding completed. Redirecting...", false);
  setTimeout(() => (location.href = "/jobseeker-dashboard.html"), 850);
}
