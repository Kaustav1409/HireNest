...
public class JobService {
    ...
    public Job postJob(JobDtos.JobRequest request) {
        ...
        job.setRoleType(request.roleType);
        job.setPlatformJob(false);
    ...
    /** Recruiter-owned jobs only (excludes HireNest Partner Network seed jobs). */
    public List<Job> recruiterCustomJobs(Long recruiterId) {
        return jobRepository.findByRecruiterIdAndPlatformJobFalse(recruiterId);
    }

    public List<Job> recruiterJobs(Long recruiterId) {
        return recruiterCustomJobs(recruiterId);
    }

    public List<Job> platformPartnerJobs() {
        return jobRepository.findByPlatformJobTrue();
    }

    public long platformJobCount() {
        return jobRepository.countByPlatformJobTrue();
    }
    ...
    public SavedJob saveJob(JobDtos.SaveJobRequest request) {
